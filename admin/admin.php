...
<tr>
<th width="20%"><label for="id_admin">ID Admin</label>
<th width="1%">:
<th colspan="2"><b><?php echo $id_admin;?></b></tr>
<tr>
<td><label for="nama_admin">Nama Admin</label>
<td>:<td width="213"><input required name="nama_admin" class="form-control" type="text" id="nama_admin" value="<?php echo $nama_admin;?>" size="25" />
</td>
...
<td colspan="2"><input name="Simpan" type="submit" id="Simpan" value="Simpan" class="btn btn-primary" />
        ...
        <a href="?mnu=admin"><input name="Batal" type="button" id="Batal" value="Batal" class="btn btn-danger" /></a>
</td></tr>
</table>
</form>
<br />
